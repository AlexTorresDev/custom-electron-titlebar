...
> Please use [Issue report template](https://github.com/AlexTorresSk/custom-electron-titlebar/blob/master/.github/ISSUE_TEMPLATE/issue-report.md) for send a new issue.
